/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 7de35cdf9e5a04fee7a4713b67d6e6ba)
...
interface __BaseEnv_Env {
	...
	REVIEW_PULL_REQUEST_WORKFLOW: Workflow<Parameters<import("./src/index").ReviewPullRequestWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_WEBHOOK_SECRET" | "GITHUB_APP_ID" | "GITHUB_APP_PRIVATE_KEY" | "GEMINI_API_KEY" | "GEMINI_MODEL" | "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_OAUTH_CLIENT_SECRET" | "SESSION_SECRET">> {}
}
